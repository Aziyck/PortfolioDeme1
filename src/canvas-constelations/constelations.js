const constelationsJS = () => {
    ...
    const MAX_NUMER_OF_ENTITIES_PER_ARRAY = 75;
    ...
    const COLOR_OF_SHAPES = "99, 102, 241";
    ...
    const COEFICIENT_OF_SMOLNESS = 0;
    ...
    setTimeout(function(){
        ...
        const mainArray = [];
        let ctx = createCanvas("canvas1", '.hero');
...
export default constelationsJS;
